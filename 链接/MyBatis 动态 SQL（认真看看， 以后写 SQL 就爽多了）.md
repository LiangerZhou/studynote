> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 https://www.cnblogs.com/homejim/p/9909657.html
...
[mybatis 最新源码和注释](https://github.com/homejim/mybatis-cn)
...
<pre>where 1=1 and name like concat('%', ?, '%') and sex=? 
</pre>
