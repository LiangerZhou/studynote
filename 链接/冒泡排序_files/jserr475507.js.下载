...
e.like_num=e.like_num||0,1*e.is_anoymous&&1*!e.is_self_question&&(e.questioner_nickname="Anonymous",
...
var f=l.getAttribute("data-linktype"),g=l.getAttribute("href");
...
if(i.innerText="即将打开新的页面",a[g]&&a[g].subject_name&&"0"===a[g].item_show_type&&a[g].title?i.innerText='即将打开公众号 "'+a[g].subject_name+'" 的'+s[a[g].item_show_type]+"《"+a[g].title+"》":a[g]&&a[g].subject_name&&a[g].item_show_type>=0&&(i.innerText='即将打开公众号 "'+a[g].subject_name+'" 的'+s[a[g].item_show_type]),
e.stopPropagation(),"undefined"==typeof p[g]&&(g.indexOf("mp.weixin.qq.com/s/")>-1||g.indexOf("mp.weixin.qq.com/s?")>-1)?(new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=110809_6_1&r="+Math.random():"undefined"==typeof p[g]&&((new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=110809_7_1&r="+Math.random()),
p=function(){
return a[g]&&a[g].item_show_type>=0&&u.indexOf("mp.weixin.qq.com")>-1&&(m.isIOS||m.isAndroid)&&!m.isInMiniProgram?1==l.getAttribute("clicked")?!1:(r.invoke("openWebViewUseFastLoad",{
url:u,
item_show_type:a[g].item_show_type,
openType:0,
scene:1
},function(e){
...
for(var i=e("biz_common/dom/event.js"),o=e("appmsg/open_url_with_webview.js"),r=e("biz_wap/jsapi/core.js"),m=e("biz_wap/utils/mmversion.js"),s=(e("biz_wap/utils/ajax.js"),
{
0:"文章",
11:"文章",
8:"Image",
7:"Audio",
5:"Video"
}),a={},c=0;c<jumpInfo.length;c++)a[jumpInfo[c].url]={
...
var _=i[r],m=_.getAttribute("data-src")||"",l=_.getAttribute("src")||m;
if(l){
var c=e("pages/version4video.js");
if(0==l.indexOf("http://z.weishi.com/weixin/player.html"))l=l.replace(/width=\d+/g,"width="+s),
l=l.replace(/height=\d+/g,"height="+d),_.width=s,_.height=d,_.style.setProperty&&(_.style.setProperty("width",s+"px","important"),
_.style.setProperty("height",d+"px","important")),_.setAttribute("src",l),window.__addIdKeyReport&&window.__addIdKeyReport("28307",10),
...
m.innerHTML=j.tmpl(u,t[_]);
{
var l=m.children[0],c=s.parentNode,p=c.insertBefore(l,s),w=p.children[0];
(function(e,t){
...
t.share_redirect_url&&g&&(window._share_redirect_url=t.share_redirect_url,g.innerHTML=j.tmpl(y,{
url:t.share_redirect_url
})),c.initCommentByExtData(t),I.setBackgroundClass(),l.init(t.reward,{
...
var u=document.getElementById("js_cmt_container");
1==t.comment_entrance_enable_for_preview&&window.is_temp_url&&u&&(u.style.display="block"),
...
e.preventDefault(),r("Unable to do this in preview");
})),t.comment_enabled&&u&&(u.style.display="block");
}
function _(e){
...
both_ad:0,
reward_uin_count:is_need_reward?3*l.getCountPerLine({
can_reward:!0
})-1:0,
...
if(t)try{
var n="";
if(t.friend_subscribe_count>0?(n=t.friend_subscribe_count+" friend(s) following",
_(n),x.set("currentMpInfoDesc"+biz,n)):t.original_article_count>0&&(n=t.original_article_count+" original article(s)",
...
e("biz_common/utils/string/html.js");
var l=e("appmsg/reward_utils.js"),c=e("appmsg/comment_utils.js"),p=e("pages/create_txv.js"),w=e("pages/video_ctrl.js"),g=e("biz_common/utils/url/parse.js"),u=e("appmsg/img_copyright_tpl.html.js"),h=e("appmsg/appmsgext.js"),y=e("appmsg/share_tpl.html.js"),v=navigator.userAgent,f=-1!=v.indexOf("MicroMessenger"),b=(-1!=navigator.userAgent.indexOf("WindowsWechat"),
