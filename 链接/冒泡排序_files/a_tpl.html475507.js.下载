...
function c(){
_t.mylist.children.length?(m(_t.mylist.parentNode),H.removeClass(document.body,nt)):(i(_t.mylist.parentNode),
H.addClass(document.body,nt));
}
function d(){
setTimeout(function(){
m(_t.toast);
...
var n=new Image;
n.src=V.idkey?"//mp.weixin.qq.com/mp/jsmonitor?idkey="+(V.idkey+"_"+e+"_1")+"&t="+Math.random():"http://mp.weixin.qq.com/mp/jsreport?key="+e+"&content="+(t||"")+"&r="+Math.random();
}
}
function r(){
...
function p(e){
e=e===!0,e&&(ct=0);
var t=r(),n=document.documentElement.scrollHeight;
if(n<t+Q.getInnerHeight()+100&&X.off(window,"scroll",p),!(at||-1==ct||ct>0&&n-t-Q.getInnerHeight()>500)){
...
var o=+new Date;
at=!0,i(_t.tips),m(_t.loading);
var c="/mp/appmsg_comment?action=getcomment&scene="+V.scene+"&__biz="+biz+"&appmsgid="+appmsgid+"&idx="+idx+"&comment_id="+W+"&offset="+ct+"&limit="+dt+(window.send_time?"&send_time="+send_time:"");
try{
ft++,e&&(gt=[]),ft>1&&!e&&l(V.moreList,encodeURIComponent(c)),gt.indexOf(c)>-1&&l(V.repeatList,encodeURIComponent(c)),
gt.push(c);
}catch(d){}
!!R&&console.info("[图文评论] 开始请求评论数据:",c),K("[Appmsg comment] start get comment data, url:"+c),
Z({
url:c,
type:"get",
success:function(t){
...
var r=+new Date-n;
s(m,r);
}else l(V.errList,"type:resperr;url:"+encodeURIComponent(c)+";ret="+a);
K("[Appmsg comment] get comment success"),_();
},
error:function(){
l(V.errList,"type:ajaxerr;url:"+encodeURIComponent(c)),K("[Appmsg comment] get comment ajax error");
},
complete:function(){
at=!1,i(_t.loading),X.off(window,"scroll",M);
}
});
}
}
...
l(V.handleList,encodeURIComponent(JSON.stringify({
comment_id:W,
offset:ct,
url:location.href
...
1!=e.enabled?(O&&(O.style.display="none"),S&&i(S),e.elected_comment=[],e.friend_comment=[],
e.elected_comment_total_cnt=0,e.friend_comment_total_cnt=0):(O&&(O.style.display="block"),
S&&m(S)),0==ct?(st=e.logo_url,lt=e.nick_name,t&&(pt=[]),n=e.elected_comment,n&&n.length?(w(n,c,"elected"),
t&&(_t.list.innerHTML=""),_t.list.appendChild(c),m(_t.main),0==window.can_fans_comment_only||1==window.can_fans_comment_only&&1==e.is_fans?m(document.getElementById("js_cmt_addbtn1")):m(document.getElementById("js_cmt_nofans1"),"block"),
e.elected_comment_total_cnt<=10&&(m(document.getElementById("js_cmt_statement")),
m(document.getElementById("js_cmt_qa")))):(i(_t.main),0==window.can_fans_comment_only||1==window.can_fans_comment_only&&1==e.is_fans?m(document.getElementById("js_cmt_addbtn2")):m(document.getElementById("js_cmt_nofans2"),"block")),
o=e.friend_comment,w(o,d,"friend"),o&&0==o.length&&i(S),t&&(_t.fdlist.innerHTML=""),
_t.fdlist.appendChild(d),o&&o.length?(m(_t.fdmain),(0==window.can_fans_comment_only||1==window.can_fans_comment_only&&1==e.is_fans)&&(i(document.getElementById("js_cmt_addbtn1")),
i(document.getElementById("js_cmt_addbtn2")),m(document.getElementById("js_cmt_addbtn3")))):i(_t.fdmain),
...
}()):(n=e.elected_comment,n&&n.length&&(w(n,c,"elected"),_t.list.appendChild(c))),
0==e.elected_comment_total_cnt?(ct=-1,i(document.getElementById("js_cmt_loading")),
i(document.getElementById("js_cmt_statement")),i(document.getElementById("js_cmt_qa"))):ct+dt>=e.elected_comment_total_cnt?(ct=-1,
i(document.getElementById("js_cmt_loading")),m(document.getElementById("js_cmt_statement")),
m(document.getElementById("js_cmt_qa"))):ct+=e.elected_comment.length;
}
function g(){
it.log("tag1");
var e=a(_t.input.value);
if(it.log("tag2"),!H.hasClass(_t.submit,"btn_disabled")){
if(it.log("tag3"),e.length<1)return b("Comment cannot be blank");
if(it.log("tag4"),e.length>600)return b("600 characters max");
it.log("tag5"),H.addClass(_t.submit,"btn_disabled"),it.log("tag6");
var t=document.getElementById("activity-name");
it.log("tag7"),yt!=e&&(wt=+new Date);
var n=function(t){
{
...
}],n,"mine"),_t.mylist.insertBefore(n,_t.mylist.firstChild);
c(),_t.input.value="",D();
};
if(window.test_comment_data)return void n({
my_id:"111"
});
var o="/mp/appmsg_comment?action=addcomment&scene="+V.scene+"&comment_id="+W+"&__biz="+biz+"&idx="+idx+"&appmsgid="+appmsgid+"&sn="+sn;
Z({
url:o,
data:{
content:e,
...
case-6:
b("You're commenting too frequently. Take a break and try again later.");
break;

case-7:
b("You have not followed this Official Account yet. Unable to comment.");
break;

case-10:
b("600 characters max");
break;

case-15:
b("Comments have been disabled");
break;

default:
yt=e,b("System error. Try again later.");
}
0!=m.ret&&l(V.addCommentErr,"type:resperr;url:"+encodeURIComponent(o)+";ret="+m.ret);
},
error:function(e){
it.log("shit;"+e.status+";"+e.statusText),l(V.addCommentErr,"type:ajaxerr;url:"+encodeURIComponent(o));
},
complete:function(){
""!=_t.input.value&&H.removeClass(_t.submit,"btn_disabled");
}
});
}
}
function f(){
if(c(),0==rt){
var e="/mp/appmsg_comment?action=getmycomment&scene="+V.scene+"&__biz="+biz+"&appmsgid="+appmsgid+"&idx="+idx+"&comment_id="+W,t=document.getElementById("js_mycmt_loading");
rt=1,m(t),Z({
url:e,
type:"get",
success:function(t){
...
i&&i.length&&(w(i,c,"mine"),_t.mylist.appendChild(c)),rt=2;
}else rt=0,l(V.errComment,"type:resperr;url:"+encodeURIComponent(e)+";ret="+m);
},
error:function(){
rt=0,l(V.errComment,"type:ajaxerr;url:"+encodeURIComponent(e));
},
complete:function(){
i(t),c();
}
...
a.time=y(a.create_time),a.status="",a.logo_url=a.logo_url||c,a.logo_url=-1!=a.logo_url.indexOf("wx.qlogo.cn")?a.logo_url.replace(/\/132$/,"/96"):a.logo_url,
...
a.report_elected=a.is_elected||0,a.report_friend=a.is_from_friend||0,a.scene=d,a.reply.reply_list.length>0&&(a.reply.reply_list[0].time=y(a.reply.reply_list[0].create_time),
...
a.new_appmsg=window.new_appmsg,m+=$.tmpl(q,a);
try{
var r=a.nick_name+a.content,_=!1,p=V.repeatContentID;
ut[r]&&(_=!0,p=V.repeatContent),pt.indexOf(a.content_id)>-1&&(_=!0,p=V.repeatContentID),
pt.push(a.content_id),ut[r]=!0,_&&l(p,encodeURIComponent(JSON.stringify({
comment_id:W,
...
for(i.innerHTML=m,h(i);o=i.children.item(0);)t.appendChild(o);
}
function h(e){
it.each(e.querySelectorAll("div.discuss_message_content"),function(e){
e.innerHTML=mt.encode(e.innerHTML);
});
}
function b(e){
...
function I(e){
et=r(),i(_t.article),m(_t.mine),window.__second_open__&&F.os.ios&&m(_t.fakebar),
window.scrollTo(0,0),f(),e||it.later(function(){
_t.input.focus();
});
}
function v(){
i(_t.mine),m(_t.article),console.log(et),window.scrollTo(0,et),_t.input.blur(),H.removeClass(document.body,tt),
H.removeClass(document.body,nt),Q.isNativePage()||"5"!==window.item_show_type||(J.invoke("setNavigationBarColor",{
color:"#1f1f1f"
...
for(var o=parseInt(n.dataset.status),m=0==o?1:0,i=n.dataset.contentId,c=n.dataset.scene,d=document.querySelectorAll('.js_comment_praise[data-content-id="'+i+'"]'),a=0;a<d.length;a++)C(d[a]);
...
function B(e){
for(var t=e.delegatedTarget,n=parseInt(t.dataset.status),o=n?0:1,m=t.dataset.contentId,i=t.dataset.replyId,c=t.dataset.scene,d=document.querySelectorAll('.js_reply_praise[data-content-id="'+m+'"]'),a=0;a<d.length;a++)C(d[a]);
document.querySelector("meta[name=viewport]"),window.test_comment_data||Z({
...
function D(){
_t.list.children.length?_t.fdlist.children.length?(m(document.getElementById("js_cmt_addbtn3")),
...
i(document.getElementById("js_cmt_addbtn4"))):_t.fdlist.children.length?(m(document.getElementById("js_cmt_addbtn3")),
...
_t.list.children.length?_t.fdlist.children.length||i(_t.fdmain):(i(_t.main),i(document.getElementById("js_cmt_statement")),
i(document.getElementById("js_cmt_qa")),_t.fdlist.children.length||i(_t.fdmain)),
c(),D();
}
function z(e){
var t=e.delegatedTarget,n=t.getAttribute("data-my-id"),m="/mp/appmsg_comment?action=delete&scene="+V.scene+"&__biz="+biz+"&appmsgid="+appmsgid+"&comment_id="+W+"&my_id="+n;
confirm("确定删除吗？")&&Z({
url:m,
success:function(e){
var m=t;
...
function x(e){
e&&e.preventDefault(),v(),i(_t.fakebar);
}
function M(){
try{
var e=_t.loading.getBoundingClientRect(),t=Math.random()<1;
e.top<Q.getInnerHeight()&&at&&t&&((new Image).src="//mp.weixin.qq.com/mp/jsmonitor?idkey=28307_45_1&lc=1&log0",
X.off(window,"scroll",M));
}catch(n){}
}
function L(e,t){
if(!k()){
if(Q.isNativePage()||"5"!==window.item_show_type||(H.addClass(document.body,tt),
J.invoke("setNavigationBarColor",{
color:"#191919"
}),J.invoke("setBounceBackground",{
backgroundColor:"#191919"
})),t)return!!R&&console.log("FakeHash on comment"),void I();
e.preventDefault(),window.__second_open__&&F.os.ios?I():(!!R&&console.log("push comment"),
G.push("comment"));
}
}
var H=e("biz_common/dom/class.js"),q=e("appmsg/cmt_tpl.html.js"),O=document.getElementById("js_cmt_area"),S=document.getElementById("js_friend_cmt_area"),N=e("biz_common/utils/wxgspeedsdk.js"),A=e("appmsg/comment_report.js"),R=location.href.indexOf("vconsole=1")>0||document.cookie&&document.cookie.indexOf("vconsole_open=1")>-1?!0:!1,F=e("biz_wap/utils/device.js"),U=e("appmsg/retry_ajax.js"),P=e("biz_common/dom/offset.js"),Y=e("biz_common/utils/url/parse.js"),J=e("biz_wap/jsapi/core.js"),Q=e("common/utils.js"),W=0;
if(window._has_comment=!0,"undefined"!=typeof window.comment_id?W=window.comment_id:window.cgiData&&"undefined"!=typeof window.cgiData.comment_id&&(W=window.cgiData.comment_id),
!!R&&console.info("[图文评论] 评论ID:",W),-1!=navigator.userAgent.indexOf("MicroMessenger")||window.test_comment_data||(O&&(O.style.display="none"),
S&&(S.style.display="none"),W=0,window._has_comment=!1),0==W)return void(window._has_comment=!1);
var X=e("biz_common/dom/event.js"),Z=e("biz_wap/utils/ajax.js"),$=(e("biz_common/utils/string/html.js"),
e("biz_common/tmpl.js")),G=e("biz_wap/utils/fakehash.js"),K=e("appmsg/log.js"),V={
scene:0,
idkey:"",
moreList:27,
repeatList:25,
...
var ot,mt=e("appmsg/emotion/emotion.js"),it=e("appmsg/emotion/dom.js"),ct=(new Image,
0),dt=100,at=!1,st="",lt="我",rt=0,_t={
...
},pt=[],ut={},gt=(new Image,[]),ft=0,yt=null,wt=+new Date;
if(window.__second_open__&&F.os.ios&&(_t.mine.style.marginBottom=getComputedStyle(_t.fakebar).height),
function(){
p(),j(),mt.init();
}(),G.on("comment",function(){
L(null,!0);
}),G.on("article",function(){
!!R&&console.log("FakeHash on article"),v();
}),G.on(function(e){
"comment"==e&&v();
}),X.on(_t.input,"input",function(){
var e=a(_t.input.value);
e.length<1?H.addClass(_t.submit,"btn_disabled"):H.removeClass(_t.submit,"btn_disabled");
}),X.on(_t.list,"click",".js_comment_praise",E),X.on(_t.mylist,"click",".js_comment_praise",E),
X.on(_t.fdlist,"click",".js_comment_praise",E),X.on(_t.list,"click",".js_reply_praise",B),
X.on(_t.fdlist,"click",".js_reply_praise",B),X.on(_t.list,"click",".js_del",z),X.on(_t.mylist,"click",".js_del",z),
X.on(_t.fdlist,"click",".js_del",z),Q.listenMpPageAction(function(e){
"deleteComment"===e.action&&T(document.getElementById("cid"+e.personal_comment_id),e.personal_comment_id);
}),X.on(_t.list,"click",".js_del",function(e){
e.preventDefault();
}),X.on(_t.mylist,"click",".js_del",function(e){
e.preventDefault();
}),X.on(_t.fdlist,"click",".js_del",function(e){
e.preventDefault();
}),X.on(_t.submit,"click",g),X.on(_t.submit,"click",function(e){
e.preventDefault();
}),_t.goback&&(X.on(_t.goback,"click",x),X.on(_t.goback,"click",x)),window.__second_open__&&F.os.ios){
X.on(_t.input,"click",function(){
i(_t.fakebar);
}),X.on(_t.input,"blur",function(){
console.log("input blur"),"none"!=_t.mine.style.display&&m(_t.fakebar);
});
var ht=null,bt=null;
X.on(window,"orientationchange",function(){
"none"!==_t.fakebar.style.display&&(clearTimeout(ht),ht=setTimeout(function(){
window.innerWidth!==parseFloat(getComputedStyle(_t.fakebar).width)&&(clearTimeout(bt),
_t.mine.style.height=Q.getInnerHeight()+"px",window.scrollBy&&window.scrollBy(0,1),
bt=setTimeout(function(){
window.scrollBy&&window.scrollBy(0,-1),_t.mine.style.height="";
},100));
},50));
});
}
X.on(window,"scroll",p),X.on(window,"scroll",M),X.on(document.getElementById("js_cmt_write1"),"click",function(e){
L(e);
}),X.on(document.getElementById("js_cmt_write2"),"click",function(e){
L(e);
}),X.on(document.getElementById("js_cmt_write3"),"click",function(e){
L(e);
}),X.on(document.getElementById("js_cmt_write4"),"click",function(e){
L(e);
}),X.bindVisibilityChangeEvt(function(e){
e&&r()<P.getOffset(_t.cmtContainer).offsetTop-Q.getInnerHeight()&&p(!0);
});
});function _typeof(e){
...
function o(e,t){
var a=function(){
A.src=t+"&qrcode_timestamp="+1*new Date+"#wechat_redirect";
},n=null;
return function(t){
...
var A="/mp/authorreward?action=getqrcode&author_id="+k.author_id+"&rewardsn="+e.rewardsn+"&timestamp="+e.timestamp+"&__biz="+biz+"&appmsgid="+mid+"&idx="+idx+"&size=160";
if(T=o(s.replace(r,"&__tc=1"+r),A),z=o(s,A),m.on(w,"click",T),k.author_id&&1==e.can_reward&&v&&m.on(v,"click",z),
...
var R=b.rewardLinkText;
R&&(R.innerText="Like the Author",Math.random()<.05?R.innerText="Kudos to the Author":Math.random()>.05&&Math.random()<.1&&(R.innerText="Love the Author")),
b.rewardTotalText&&(b.rewardTotalText.innerText=" like(s)"),k.isWindowsWechat&&b.reward.classList.add("reward_area_win");
}
}
...
var T=function(){},z=function(){},A=document.getElementById("js_author_reward_qrcode_img");
return{
handle:function(e,t){
u=t,w(e),s(e);
},
