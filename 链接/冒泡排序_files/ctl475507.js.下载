...
e.albumurl=i?l.imgroot2.replace("#mid#",i):l.imgroot+e.albumurl;
}
return e.albumurl=e.albumurl.replace("mid_album_68","mid_album_90").replace("68x68","90x90"),
e.musicIcon=l.musicIcon,e.type=1*r.scene===0?0:1*r.scene===1?1:8,c.inQMClient?(e.allowPause=!0,
...
function t(e,r){
var t=e,a=l.cache[t.songId];
return c.inQMClient?void r.callback({
canplay:!0,
play_url:"https://www.qq.com"
}):a&&"function"==typeof r.callback?(a.in_cache=!0,void r.callback(a)):void(l.submiting[t.songId]!==!0&&(l.submiting[t.songId]=!0,
s({
id:t.songId,
mid:t.mid,
onSuc:function(e){
l.submiting[t.songId]=!1,l.cache[t.songId]=e,"function"==typeof r.callback&&r.callback(e);
},
onError:function(){
l.submiting[t.songId]=!1,"function"==typeof r.callback&&r.callback({
canplay:!1,
msg:"System busy. Try again later. (Return Code: -1)",
status:-1,
play_url:"",
...
case 2:
r=!1,t="Unfortunately, this song is not available in your current country/region due to copyright restrictions.";
break;
...
case 7:
r=!1,t="This music is not free. You can listen to it in QQ Music.";
break;

case 8:
r=!0,t="The music is not free. You can only listen to part of it.";
break;

default:
r=!1,t="System error. Try again later.";
}
return t&&1*e!==7&&(t+="Error code: "+e),{
canplay:r,
msg:t
};
}
function s(e){
i.setSum(l.reportId,18,1),i.send();
var r=+new Date,t="//mp.weixin.qq.com/mp/qqmusic?action=get_song_info&song_mid=#mid#";
t=t.replace("#mid#",e.mid),n({
url:t,
type:"GET",
dataType:"json",
success:function(t){
...
var l,u=(i.ret,i.songlist[0].song_play_url),m=i.songlist[0].song_play_time||0;
i.songlist[0].playable?l=u?0:6:i.songlist[0].try_playable?i.songlist[0].try_file_size>0&&i.songlist[0].try_30s_url?(l=8,
u=i.songlist[0].try_30s_url,m=30):l=6:l=7,o({
type:"success",
time:s,
code:l
});
...
function o(e){
var r=Math.max(e.time,0);
if(r=Math.min(r,6e4),e.time>=0&&e.time<200?i.setSum(l.reportId,24,1):e.time>=200&&e.time<500?i.setSum(l.reportId,25,1):e.time>=500&&e.time<1e3?i.setSum(l.reportId,26,1):e.time>=1e3&&e.time<2e3?i.setSum(l.reportId,27,1):e.time>=2e3&&e.time<1e4?i.setSum(l.reportId,28,1):e.time>=1e4&&i.setSum(l.reportId,29,1),
i.setAvg(l.reportId,23,r),"error"==e.type){
switch(1*e.code){
case 1:
i.setSum(l.reportId,9,1);
break;

case 2:
i.setSum(l.reportId,10,1);
break;

case 3:
i.setSum(l.reportId,11,1);
break;

case 4:
i.setSum(l.reportId,12,1);
}
i.setSum(l.reportId,19,1);
}else if("success"==e.type){
switch(1*e.code){
case 1:
i.setSum(l.reportId,8,1);
break;

case 0:
i.setSum(l.reportId,17,1);
break;

case 2:
i.setSum(l.reportId,13,1);
break;

case 3:
i.setSum(l.reportId,14,1);
break;

case 4:
i.setSum(l.reportId,15,1);
break;

case 5:
i.setSum(l.reportId,16,1);
break;

case 6:
i.setSum(l.reportId,47,1);
}
i.setSum(l.reportId,20,1);
}
i.send();
}
var i=e("biz_common/utils/monitor.js"),c=e("pages/player_adaptor.js"),n=(e("pages/loadscript.js"),
e("biz_wap/utils/ajax.js")),l={
